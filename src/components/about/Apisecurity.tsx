...
const Apisecurity = ({ sectionClass }: DataType) => {
                        ...
                        <div className="col-md-8">
                            <div className="about-style-six-info text-scroll-animation" ref={containerRef}>
                                <div className="info">
                                    ...
                                    <p>An API security platform is a specialized solution designed to protect application programming interfaces (APIs) from misuse, abuse, and attacks across their entire lifecycle. As APIs have become the backbone of modern applications. It  powers mobile apps, cloud services, microservices, and third-party integrations. They have also become a prime target for attackers. Traditional security tools often fall short because APIs behave differently from web applications, making dedicated API security essential.
                                    </p>
                                </div>
