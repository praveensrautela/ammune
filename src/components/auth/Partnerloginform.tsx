import PartnerloginForm from "../form/PartnerLogin";

interface DataType {
    sectionClass?: string
}

const Partnerloginform = ({ sectionClass }: DataType) => {
    return (
        <>
                        ...
                        <div className="row">
                            ...
                            <div className="col-tact-stye-one col-lg-6 offset-lg-1">
                                <div className="contact-form-style-one">
                                    <h4 className="sub-title">Sign in</h4>
                                    <PartnerloginForm />
                                </div>

                                <div className="mt-2 text-end">
                                    <p>Don't have an account? <a href="/partner-register">Sign up</a></p>
                                </div>
