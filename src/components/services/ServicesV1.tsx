                                    ...
                                    <div className="site-heading">
                                        ...
                                        <h2 className="title split-text">
                                            <SplitText
                                                ...
                                                rootMargin="-50px"
                                            >
                                                The Air Gap Edge with Ammune.ai
                                            </SplitText>
                                        </h2>
                                        <p>
                                            Move over SaaS-based solutions. Our air-gapped autonomous
                                            AI model keeps your data within your network only.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {ServicesV1Data.slice(0, 4).map((service) => (
                                ...
                                >
                                    <div className={`services-style-one-item ${activeServiceId === service.id ? 'active' : ''}`}>
                                        ...
                                        <p>{service.text}</p>
                                        <Link className="btn-full" to={`/why-ammuneai`}>
